...
def OTA_Assertions(info, input_zip):
  ...
  if m:
    ...
    cmd = ('assert(samsung_sm7450.verify_bootloader_min("{}") == "1" || abort("ERROR: This package requires Android 13 based firmware. Please upgrade firmware and retry!"););').format(bootloader_version)
